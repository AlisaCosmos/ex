            ...
            <div className="footer__dataAndAdditionalLinks">
              ...
              <div className="footer__data">
                ...
                <div>
                  ...
                  Армения, г. Ереван<br className="footer__tablet_visible footer__landscape_hidden"/> ул. Ерванда Кочара, д. 8/7
                  <br />
                  Почта:{" "}
                  <a className="footer__mail" href="mailto:info@eximpartners.online">
                    info@eximpartners.online
                  </a>
                </div>
              </div>
            </div>
